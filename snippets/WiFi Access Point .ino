...
Uses a web form to collect Wifi credentials and stores them in EEPROM
Note how a HTML home page is hard coded withing the .ino file
*/
#include <EEPROM.h>
...
//-------------------------------------------------------------------------------------
// NOTE: Here we use a hard coded HTML portal page ***
...
void handleRoot() {
   if (server.hasArg("ssid")&& server.hasArg("Password")&& server.hasArg("IP")&&server.hasArg("GW") ) {
