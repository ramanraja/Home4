...
def set_data():
    ...
    #try :
    dev_data = {'device_id':'NON-EXIST', 'relay_status':'0101', 'data':simul_data} 
    maria.insertDeviceData (dev_data)  
    #except Exception as e:
    #    print (str(e))
    print ()
...
def get_data():
    ...
    print (dev_data)
    dev_data = maria.getDeviceData ({'device_id':'NON-EXIST'})
    print (dev_data)    
    print ()
...
def get_dev_config():
    ...
    print(dc)
    print()
    dc = maria.getDeviceConfig ({'device_id':'NON-EXIST'})
    print(dc)
    print()    
...
def set_dev_config():
    ...
    dev_con['device_id'] = 'NON-EXIST'
    maria.insertDeviceConfig (dev_con)
    print()          
    
def dev_exits(): 
    print ('Device existence:')
    devex = maria.deviceExists ({'device_id':TEST_MAC1})  
    print(devex)   
    devex = maria.deviceExists ({'device_id':'no-such-dev'}) 
    print(devex)      
    devex = maria.deviceExists ({'device_id':TEST_MAC2}) 
    print(devex)      
    print()
...
print()
maria.connect (db=PasswordStore.db_name, host=PasswordStore.db_host, port=PasswordStore.db_port)
