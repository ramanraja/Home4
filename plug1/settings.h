...
#define  APP_NAME                "Internet relays-4.1"  // this is only for display
...
#define  PRIMARY_LIGHT_CORRECTION    100   // when primary light is ON, it contributes this much light to the LDR
