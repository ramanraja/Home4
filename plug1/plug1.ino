// This is a stand-alone net socket with 4 relays :  intof/home/status/G0/mac_id
...
This is the  internet relays project using Rhydolabs quad relay board ESP07
Operates 4 solid state IoT relays through an MQTT broker on the local wifi/internet.
...
#define  APP_ID                 "home"  
#define  APP_NAME               "Internet Relays"  

conf_home.txt: 
"ACTIVE_LOW":0,
"PRIMARY_REL":0,
"NIGHT_HRS":[0,0,0,0]  <- this is important to maintain audo_dawn_dusk_mode=FALSE
...
#define RELAY1        13       
#define RELAY2        12  
#define RELAY3        14      // for the 4-relay module
#define RELAY4        16            
#define LED           2
*******************************************************************************************/
